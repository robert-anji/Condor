...
InterfaceDescription RW_Interface[] = {
  eRWIntf_Clk,  cRWIntf_Clk,   1, eSignalType_Input,   "CLK",
  eRWIntf_Req,  cRWIntf_Req,   1, eSignalType_Output,  "RW",
  eRWIntf_Addr, cRWIntf_Addr, 32, eSignalType_Output,  "RW",
  eRWIntf_Data, cRWIntf_Data, 32, eSignalType_Output,  "RW",
  eRWIntf_Ack , cRWIntf_Ack ,  1, eSignalType_Input,   "RW",
